...
public class FSTWorkDemo {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < intsRefUserInput.length; i ++) {
            FST.Arc<Long> targetArc = fst.findTargetArc(intsRefUserInput.ints[intsRefUserInput.offset + i], arc, arc, fst.getBytesReader());
            System.out.println("label is : "+targetArc.label());
